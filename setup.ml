...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9bfb13d5e10353fd6a56c2777669a872) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Websocket library for Lwt";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Opt"; "Monad"; "Websocket"];
                      lib_pack = false;
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "tests";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "websocket"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "wscat.ml"; })
            ];
          plugins =
            [
               (`Extra, "META", Some "0.3");
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\139\145\219\186~\163\146;\172#\019\195X\155\158\000";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
